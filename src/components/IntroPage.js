...
const IntroPage = ({ moveToQuiz }) => {
    ...
    return(
        <Container>
            ...
            <CallToActionText>Our homes produce over one eighth of the United States' total emissions. <span style={{fontWeight: "bold"}}>Take this quiz to determine how best to lower your home's footprint!</span></CallToActionText>
